...
```bash
curl -OJ http://localhost:8080/api/v1/tasks/exports/tasks.csv
```

UTF-8과 CRLF 행 구분자를 사용하며 쉼표, 큰따옴표, 줄바꿈이 포함된 필드는 RFC 4180 방식으로 인용합니다.
...
| `GET` | `/api/v1/tasks/exports/tasks.csv` | 전체 작업 CSV 다운로드 |
